...
<div>
    <div>
        ...
        <el-input style="width: 200px; margin: 0 5px" placeholder="查询用姓名" v-model="name"></el-input>
...
export default {
    ...
    methods:{
        ...
        exportData(){    //批量导出数据
            if(!this.ids.length){   //没有选择的时候，全部导出 或者根据我的搜索条件导出
        ...
        load(pageNum){             //分页查询
          ...
          this.$request.get('/user/selectByMoPage',{
              params:{
